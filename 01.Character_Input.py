...
Every week there will be a poll you can click on to discuss whether the 
exercise is too easy or too hard and hopefully in a few weeks, I’ll get the level right. 
...
"""
age = int(input("Input is your current age: "))
#num = int(input("How many times would you like to repeat the final message: "))
